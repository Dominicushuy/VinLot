// src/app/admin/provinces/new/page.tsx
...
import { useCreateProvince } from "@/lib/hooks/use-provinces";
import {
  provinceSchema,
  ProvinceFormValues,
...
export default function NewProvincePage() {
  ...
  const onSubmit = async (data: ProvinceFormValues) => {
    try {
      ...
      toast({
        title: "Thành công",
        description: "Tạo đài xổ số mới thành công",
      });
      ...
      toast({
        title: "Lỗi",
        description: "Đã xảy ra lỗi khi tạo đài xổ số. Vui lòng thử lại!",
        variant: "destructive",
      });
    }
  };
  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-3xl font-bold">Thêm đài xổ số mới</h1>
        <div className="space-x-2">
          ...
          >
            {createProvince.isPending ? "Đang tạo..." : "Tạo đài xổ số"}
          </Button>
        </div>
      </div>
          ...
          <CardContent className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Input id="province_id" {...form.register("province_id")} />
